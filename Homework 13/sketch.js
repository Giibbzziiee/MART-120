let player;
let obstacles = []; // array to hold all moving obstacles
let staticObstacle = null; // store non-moving obstacle
let exitZone;
...
function setup() {
  ...
  createObstacles(5); // create obstacles
...
// draw static obstacle on mouse press
